...
def test_main_with_tasks(tmp_path, capsys, monkeypatch):
...
def test_main_no_tasks(tmp_path, capsys, monkeypatch):
...
def test_main_no_markdown_files(tmp_path, capsys, monkeypatch):
